...
import com.example.InstaCopy.dto.CommentDTO;
import com.example.InstaCopy.entity.Comment;
import com.example.InstaCopy.facade.CommentFacade;
import com.example.InstaCopy.payload.response.MessageResponse;
import com.example.InstaCopy.service.CommentService;
...
public class CommentController {
    ...
    public ResponseEntity<List<CommentDTO>> getAllCommenToPost(@PathVariable("postId") String postId){
